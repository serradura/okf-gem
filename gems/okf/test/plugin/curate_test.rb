...
require "tmpdir"
require "fileutils"
# The plugin lives at the repo root, two levels above this gem (gems/okf/) —
# hence the fourth hop. Its two inputs are the gem's (the skill tree and the
# version), which is why its tests and its `rake skill:sync` task stay here
