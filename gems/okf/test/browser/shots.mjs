...
// Four hops, not two: `.github/` belongs to the repository, and this file sits
// inside the gem (gems/okf/test/browser/), so short-counting reaches the gem
// root — or, since the gems moved under gems/, the container. Written with two
// it created a stray okf/.github and wrote the images there, silently, while
// still printing that it had succeeded.
