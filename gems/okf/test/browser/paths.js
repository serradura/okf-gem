...
// The *gem* root (gems/okf/), not the repository root two levels above it —
// this is the directory `bundle exec ruby -Ilib exe/okf` has to run from, which
// is the only thing anything here uses it for. It was called repoRoot until the
// gem moved into a subdirectory and the two stopped being the same place.
