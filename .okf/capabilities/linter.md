...
description: An advisory curation-quality report across eight categories and twenty-five checks — pinned severities, an explicit clock, and it never rejects a bundle.
...
# Eight categories, twenty-five checks — with pinned severities
