...
What the `okf` gem does over an Open Knowledge Format v0.2 bundle: read it,
...
* [The format](format/) - what OKF v0.2 is — the Markdown + YAML frontmatter the gem operates on.
